...
private _chem = selectRandom["Chemlight_blue", "Chemlight_yellow"];
...
private _stick = _chem createVehicle (position _unit);
_stick attachTo [_unit, [0,-0.03,0.07], "LeftShoulder"];
